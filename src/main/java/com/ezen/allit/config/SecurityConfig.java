...
//		http.exceptionHandling().accessDeniedPage("/sellerLogin"); // 권한이 필요한 페이지를 요청할 경우
//		http.authorizeRequests() 						   // authorizeRequests(): 요청에 관한 지정
////			.antMatchers("/user/**").authenticated() 	   // authenticated(): 인증이 돼야 접근 가능 
...
//	 * 비밀번호 해쉬화
//	 */
//	@Bean // @Bean: 해당 매서드의 리턴 오브젝트를 IoC로 등록해줌
